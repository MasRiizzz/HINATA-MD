  ...
  global.available = ture // Ubah Ke false Jika Bot Mu Tidak Ingin Terlihat Online
  global.autoTyping = ture // Ubah Ke true Jika Ingin Saat Ada Yang Chat Bot Auto Mengetik
  global.autoRecord = false // Ubah Ke false Jika Tidak Ingin Saat Ada Yang Chat Bot Auto Merekam
  global.multiplier = 9999 // Semakin Besar Angkanya Semakin Sulit Untuk Naik Level
  global.limitCount = 70 // 70 Dah Pas Banh
  global.prefa = ['','.','/','#']

  // Other
  global.ownername = '𝐑𝐢𝐳𝐤𝐢 𝐌𝐮𝐡𝐚𝐦𝐦𝐚𝐝 𝐀𝐝𝐚𝐦' // Ganti Jadi Namamu
  ...
  global.author = '𝐑𝐢𝐳𝐤𝐢 𝐌𝐮𝐡𝐚𝐦𝐦𝐚𝐝 𝐀𝐝𝐚𝐦' // Sticker Weem
  ...
  global.youtube = 'https://youtube.com/channel/UCtM-pDaaGVRe4BJ7w4qECvw' // Ganti Sama Link Yt Mu
